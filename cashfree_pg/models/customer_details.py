...
class CustomerDetails(BaseModel):
    ...
    """
    customer_id: Annotated[str, StringConstraints(strict=True, max_length=50, min_length=3)] = Field(..., description="A unique identifier for the customer. Use alphanumeric values only.")
