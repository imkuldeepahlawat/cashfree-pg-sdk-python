...
class OfferTnc(BaseModel):
    ...
    """
    offer_tnc_type: Annotated[str, StringConstraints(strict=True, max_length=50, min_length=3)] = Field(..., description="TnC Type for the Offer. It can be either `text` or `link`")
    offer_tnc_value: Annotated[str, StringConstraints(strict=True, max_length=100, min_length=3)] = Field(..., description="TnC for the Offer.")
